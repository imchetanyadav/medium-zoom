  ...
  return (
    ...
    function t(e) {
          ...
          var p = (0 < arguments.length && void 0 !== arguments[0]
            ...
            g = function() {
              ...
              var a = E.zoomedHd || E.original,
                c = O(a) ? t : a.naturalWidth || t,
                u = O(a) ? o : a.naturalHeight || o,
                ...
                z =
                  ...
                  y +
                  ') translate3d(' +
                  ((t - p) / 2 - f + b.margin + e.left) / y +
                  'px, ' +
                  ((o - g) / 2 - s + b.margin + e.top) / y +
                  'px, 0)'
          ...
          return new n(function(t) {
            if (p && -1 === v.indexOf(p)) t(L)
              ...
              if (
                ...
                (a.style.transform = ''),
                a)),
                'undefined' != typeof document && document.body.appendChild(w),
                b.template)
              ) {
                var l = C(b.template)
                  ? b.template
                ...
                ;(E.template =
                  ...
                  E.template.appendChild(l.content.cloneNode(!0)),
                  'undefined' != typeof document &&
              ...
              ? ((y = !0),
                ...
                E.zoomed.addEventListener('transitionend', function e() {
                  E.original.classList.remove('medium-zoom-image--hidden'),
                    ...
                    E.zoomedHd &&
                      'undefined' != typeof document &&
                      document.body.removeChild(E.zoomedHd),
                    'undefined' != typeof document &&
                      document.body.removeChild(w),
                    E.zoomed.classList.remove('medium-zoom-image--opened'),
                    E.template &&
                      'undefined' != typeof document &&
                      document.body.removeChild(E.template),
                    (y = !1),
                    E.zoomed.removeEventListener('transitionend', e),
                    E.original.dispatchEvent(
      ...
      var a,
        c,
        w = ((a = b.background),
        (c = document.createElement('div')).classList.add(
          'medium-zoom-overlay'
        ),
          ...
          document.addEventListener('scroll', function() {
            if (!y && E.original) {
              var e =
                ...
                ('undefined' != typeof document && document.body.scrollTop) ||
                0
              Math.abs(z - e) > b.scrollOffset && setTimeout(h, 150)
            }
          }),
        'undefined' != typeof window && window.addEventListener('resize', h)
      var L = {
        open: i,
        close: h,
        toggle: r,
