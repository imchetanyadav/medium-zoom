    ...
    var c = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : {},
      ...
      g = function() {
        var a =
          ...
          b = a
        if (
          (a.background && (x.style.background = a.background),
          a.container &&
            a.container instanceof Object &&
            (b.container = _extends({}, v.container, a.container)),
          a.template)
        ) {
        ...
        return (
          ...
          r.forEach(function(a) {
            a.dispatchEvent(
              createCustomEvent('medium-zoom:update', { detail: { zoom: y } })
            )
          }),
          y
        )
        ...
        return (
          d.forEach(function(a) {
            a.classList.remove('medium-zoom-image'),
              a.dispatchEvent(
                createCustomEvent('medium-zoom:detach', { detail: { zoom: y } })
              )
          }),
      ...
      k = function(a, b) {
        ...
        return (
          ...
          s.push({ type: 'medium-zoom:' + a, listener: b, options: c }),
          y
        )
      },
      l = function(a, b) {
        ...
        return (
          ...
          (s = s.filter(function(c) {
            return (
              c.type !== 'medium-zoom:' + a ||
              c.listener.toString() !== b.toString()
            )
          })),
          y
        )
      ...
      m = function() {
          ...
          c = function() {
            ...
            if (v.container)
              if (v.container instanceof Object)
                (b = _extends({}, b, v.container)),
                  (c = b.width - b.left - b.right - 2 * v.margin),
                  (d = b.height - b.top - b.bottom - 2 * v.margin)
              else {
                var e = isNode(v.container)
                  ...
                  i = f.left,
                  j = f.top
                b = _extends({}, b, { width: g, height: h, left: i, top: j })
              }
            ;(c = c || b.width - 2 * v.margin),
              (d = d || b.height - 2 * v.margin)
        ...
        return new d(function(a) {
          ...
          if (
            ...
            w.zoomed.addEventListener('click', n),
      ...
      n = function() {
        return new d(function(a) {
          ...
          ;(t = !0),
            ...
            w.original.dispatchEvent(
              createCustomEvent('medium-zoom:close', { detail: { zoom: y } })
            ),
            w.zoomed.addEventListener('transitionend', function b() {
      ...
      o = function() {
        var a =
            0 < arguments.length && arguments[0] !== void 0 ? arguments[0] : {},
          b = a.target
        return w.original ? n() : m({ target: b })
      },
      p = function() {
        return v
      },
